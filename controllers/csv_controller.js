...
const CSV = require('../models/file');
const path = require('path');

//writing controller function for upload
...
//writing controller function for viewing the csv files
...
//writing controller function for deleting csv file
